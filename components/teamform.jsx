...
import ProfilePhotoUploader from "./uploader";
      ...
      <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
        {teams.map((team, index) => (
          ...
          >
            ...
            <p className="text-center">{team.school}</p>
...
const TeamForm = ({error, school, setSchool, fileSelected, setFileSelected, previewImg, setPreviewImg, quizload, teamName,loading, teamMembers, setTeamName, setTeamMembers, Add, teams, route }) => {
